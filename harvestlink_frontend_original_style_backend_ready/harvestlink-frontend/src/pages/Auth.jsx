      ...
      <main className="mx-auto max-w-lg px-4 py-16">
        <form onSubmit={handleSubmit} className="rounded-[2rem] bg-white p-8 shadow-soft">
          ...
          <div className="mt-8 space-y-4">
            {!isLogin && <Input label="Full Name" placeholder="Enter your name" />}
            ...
            {!isLogin && <select className="w-full rounded-2xl border border-gray-200 p-3"><option>Buyer</option><option>Exporter</option><option>Finance Partner</option></select>}
